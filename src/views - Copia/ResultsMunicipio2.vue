        ...
        <div class="card text-center m-3" style="margin-top:auto;width:100%;margin-left:20px"  >
          ...
          <v-data-table id="customers"
              ...
              <template
               ...
               >
          <tr>
                <!--td><div align="center" v-html="getResultMunicipiosResp(item.ibge_id,true,index,1)" /></td-->
                <td style="padding:1px 8px;font-size:14px;" @click="setMunic(item.city_name)"><router-link :to="{ path: 'ResultsEscola', query: { q: item.ibge_id, } }" style="font-size:14px;">{{ item.city_name }}</router-link></td>
                <td style="padding:12px"><div align="center" v-html="getResultMunicipiosResp(item.ibge_id,true,index,1)" /></td>
          </tr>
        ...
        <div class="card text-center m-3" style="margin-top:auto;width:1200px">
          ...
          <v-data-table
              ...
              <template
                ...
                <td style="padding:12px 8px;"><div align="center" v-html="getResultMunicipiosResp(item.ibge_id,false,(index+10),0)" /></td>
                <td style="padding:12px 8px;"><div align="center" v-html="getResultMunicipiosResp(item.ibge_id,false,(index+15),1)" /></td>
                <td style="padding:12px 8px;"><div align="center" v-html="getResultMunicipiosResp(item.ibge_id,false,(index+20),2)" /></td>
                ...
                <p align="center">
                <jw-pagination :items="combined" :pageSize=1 @changePage="onChangePage" circle></jw-pagination><br></p>
...
localStorage.setItem("titulo", "municipio");
  ...
  export default {
    ...
    methods: {
     ...
     //   console.log('aqui'+JSON.stringify(users));
     ...
     //   console.log('aqui'+ i);
      ...
      getResultMunicipios() {
          ...
          //localStorage.setItem("estado", info);
