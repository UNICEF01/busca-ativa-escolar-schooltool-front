...
<div>
  ...
  <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="1250px" height="660px" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
    <g>
      <a xlink:href="./relatorioestadov2?q=17&t=TO"  @mouseover="showUf(17)" @mouseleave="clearUf()">
       ...
       <a xlink:href="./relatorioestadov2?q=29&t=BA" @mouseover="showUf(29)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=28&t=SE" @mouseover="showUf(28)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=26&t=PE" @mouseover="showUf(26)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=27&t=AL" @mouseover="showUf(27)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=24&t=RN" @mouseover="showUf(24)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=23&t=CE" @mouseover="showUf(23)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=22&t=PI" @mouseover="showUf(22)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=21&t=MA" @mouseover="showUf(21)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=16&t=AP" @mouseover="showUf(16)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=15&t=PA" @mouseover="showUf(15)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=14&t=RR" @mouseover="showUf(14)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=13&t=AM" @mouseover="showUf(13)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=12&t=AC" @mouseover="showUf(12)" @mouseleave="clearUf()">
      ...
      </a><a xlink:href="./relatorioestadov2?q=11&t=RO" @mouseover="showUf(11)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=51&t=MT" @mouseover="showUf(51)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=50&t=MS" @mouseover="showUf(50)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=52&t=GO" @mouseover="showUf(52)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=41&t=PR" @mouseover="showUf(41)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=42&t=SC" @mouseover="showUf(42)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=43&t=RS" @mouseover="showUf(43)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=35&t=SP" @mouseover="showUf(35)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=31&t=MG" @mouseover="showUf(31)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=33&t=RJ" @mouseover="showUf(33)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=32&t=ES" @mouseover="showUf(32)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=53&t=DF" @mouseover="showUf(53)" @mouseleave="clearUf()">
      ...
      <a xlink:href="./relatorioestadov2?q=25&t=PB"  @mouseover="showUf(25)" @mouseleave="clearUf()">
    ...
    if (!userAdmin || auth.currentUser == null){self.location='/login'}
     ...
     export default {
       methods: {
        ...
        showUf(ufNr){
            let uf = ufid.find((item) => item.value == ufNr);
            $("#ufName").text(uf.text)           
        },
        clearUf(){
            $("#ufName").text("")           
