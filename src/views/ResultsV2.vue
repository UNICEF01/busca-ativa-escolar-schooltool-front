                        ...
                        <v-form ref="form_research" lazy-validation>
                           <table id="customers" class="v-datatable theme--light" style="margin-top:auto;background-color:#fff;border-collapse:collapse;width:100%;margin-left:20px" cellspacing="0" cellpadding="0">
                              <tbody>
                                 ...
                                 <tr v-if="consultaQtd('2',pergunta,'total') != null">
                                 ...
                                 <tr v-if="consultaQtd('3',pergunta,'total') != null">
                                 ...
                                 <tr v-if="consultaQtd('5',pergunta,'total') != null">
                                 ...
                                 <tr v-if="consultaQtd('4',pergunta,'total') != null">
                        ...
                        <v-form ref="form_research" lazy-validation>
                           <table id="customers" class="v-datatable theme--light" style="margin-top:auto;background-color:#fff;border-collapse:collapse;width:1200px;">
                              <tbody>
                                 ...
                                 <tr v-if="consultaQtd('52',pergunta,'total') != null">
                                    <td style="padding:12px 8px;text-align:center"><div v-html="consultaQtd('52',pergunta,'0')" /></td>
                                 ...
                                 <tr v-if="consultaQtd('53',pergunta,'total') != null">
                                    <td style="padding:12px 8px;text-align:center"><div v-html="consultaQtd('53',pergunta,'0')" /></td>
