            ...
            <template>
               ...
               <v-data-table
                  ...
                  <template
                     ...
                     <td style="padding:12px 8px;" v-if="item.quest_complete == 'S'">
                        <div align="center" v-html="getResultMunicipiosResp(item.ibge_id,false,(index+50),1)" />
                     </td>
                     <td style="padding:12px 8px;" v-if="item.quest_complete == 'S'"><div align="center" v-html="getResultMunicipiosResp(item.ibge_id,false,(index+1110),2)" /></td>
                  </template>
               </v-data-table>
               </div>
               </div>
