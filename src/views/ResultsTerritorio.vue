    ...
    <v-layout wrap>
      ...
      <!--  <material-stats-card
                            ...
                            <table id="customers" class="v-datatable theme--light" style="margin-top:346px;background-color:#fff;border-collapse:collapse;width:100%;margin-left:20px">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="padding:12px;width:40%"><div align="center" v-html="getResultTerritoriosResp('TAM',true,10,1)" /> </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table id="customers" class="v-datatable theme--light" style="margin-top: -80px;background-color:#fff;border-collapse:collapse;width:100%;margin-left:20px">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="padding:12px;width:40%"><div align="center" v-html="getResultTerritoriosResp('PCU',true,20,1)" /> </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table id="customers" class="v-datatable theme--light" style="margin-top: -80px;background-color:#fff;border-collapse:collapse;width:100%;margin-left:20px">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="padding:12px;width:40%"><div align="center" v-html="getResultTerritoriosResp('SAB',true,20,1)" /> </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table id="customers" class="v-datatable theme--light" style="margin-top: -80px;background-color:#fff;border-collapse:collapse;width:100%;margin-left:20px">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="padding:12px;width:40%"><div align="center" v-html="getResultTerritoriosResp('Outros',true,30,1)" /> </td>
                                    </tr>
                                </tbody>
                            </table>
       ...
       <!-- <template>
        ...
        <div class="card text-center m-3" style="margin-top:266px;width:100%;margin-left:-20px;width:247px">
      ...
      <div class="mostrarmais" style="border: 0px solid #ddd;padding:0px;" cellspacing="0" cellpadding="0">          
  <input type="radio" name="mostrarmais" :id="item.name" >
  <p>TAM</p> -->

  <!--label :for="item.name">Mostrar mais</label-->
   
   <!--
      </div>          
                
                <td style="padding:12px"><div align="center" v-html="getResultTerritoriosResp('TAM',true,index,1)" /></td>
                    ...
                    <div v-for="group in pageOfItems" :key="group.id">
                        ...
                        <v-form ref="form_research" lazy-validation>
                            ...
                            <table id="customers" class="v-datatable theme--light" style="border-spacing:0;border:0px;margin-top:370px;background-color:#fff;border-collapse:collapse!important;width:1200px;">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="padding:12px 8px;"><div align="center" v-html="getResultTerritoriosResp('TAM',false,40,2)" /> </td>
                                        <td style="padding:12px 8px;"><div align="center" v-html="getResultTerritoriosResp('TAM',false,50,1)" /> </td>
                                        <td style="padding:12px 8px;"><div align="center" v-html="getResultTerritoriosResp('TAM',false,60,0)" /> </td>
                                    </tr>
                    ...
                    <div v-for="group in pageOfItems" :key="group.id">
                        ...
                        <v-form ref="form_research" lazy-validation>
                            ...
                            <table id="customers" class="v-datatable theme--light" style="border-spacing:0;border:0px;margin-top:16px;background-color:#fff;border-collapse:collapse!important;width:1200px;">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="padding:12px 8px;"><div align="center" v-html="getResultTerritoriosResp('PCU',false,70,2)" /> </td>
                                        <td style="padding:12px 8px;"><div align="center" v-html="getResultTerritoriosResp('PCU',false,80,1)" /> </td>
                                        <td style="padding:12px 8px;"><div align="center" v-html="getResultTerritoriosResp('PCU',false,90,0)" /> </td>
                                    </tr>
                    ...
                    <div v-for="group in pageOfItems" :key="group.id">
                        ...
                        <v-form ref="form_research" lazy-validation>
                            ...
                            <table id="customers" class="v-datatable theme--light" style="border-spacing:0;border:0px;margin-top:16px;background-color:#fff;border-collapse:collapse!important;width:1200px;">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="padding:12px 8px;"><div align="center" v-html="getResultTerritoriosResp('SAB',false,70,2)" /> </td>
                                        <td style="padding:12px 8px;"><div align="center" v-html="getResultTerritoriosResp('SAB',false,80,1)" /> </td>
                                        <td style="padding:12px 8px;"><div align="center" v-html="getResultTerritoriosResp('SAB',false,90,0)" /> </td>
                                    </tr>
                    ...
                    <div v-for="group in pageOfItems" :key="group.id">
                        ...
                        <v-form ref="form_research" lazy-validation>
                            ...
                            <table id="customers" class="v-datatable theme--light" style="border-spacing:0;border:0px;margin-top:16px;background-color:#fff;border-collapse:collapse!important;width:1200px;">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="padding:12px 8px;"><div align="center" v-html="getResultTerritoriosResp('Outros',false,100,2)" /> </td>
                                        <td style="padding:12px 8px;"><div align="center" v-html="getResultTerritoriosResp('Outros',false,110,1)" /> </td>
                                        <td style="padding:12px 8px;"><div align="center" v-html="getResultTerritoriosResp('Outros',false,120,0)" /> </td>
                                    </tr>
    ...
    methods: {
     ...
     //   console.log('aqui'+ i);
      //  this.i_aux[idx].valor = i;
        ...
        //console.log('aqui'+ this.i_aux[idx].valor);
      ...
      getResultMunicipios() {
         ...
         /* for (let i = 0; i < municipios.length; i++) {
          ...
          municipios.then((municipios) => {
            ...
            /*  for (let i=0;i<=municipios.length;i++){
                if (first) { (this.municipios).push(municipio.school); }
                if (municipio.school.ibge_id == municipios[i].school.ibge_id) { first = false; } else { first = true; }
              } */
       ...
       //   console.log('aquileo'+this.removeDups((this.municipios), 'school.ibge_id'));
